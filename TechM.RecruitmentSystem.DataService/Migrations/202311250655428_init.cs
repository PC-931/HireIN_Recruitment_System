    ...
    public partial class init : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.Vacancies", t => t.VacancyId_Id)
                .Index(t => t.UserId_Id)
                .Index(t => t.VacancyId_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Applicants", "VacancyId_Id", "dbo.Vacancies");
            ...
            DropIndex("dbo.Applicants", new[] { "VacancyId_Id" });
